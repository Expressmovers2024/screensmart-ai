...
export default function SummaryRoute() {
  ...
  Scan a screenshot first, then come back here to generate summaries, explanations, and bullet points.
          </Text>
        </View>
        <ScreenCard title="Start by scanning a screen">
  ...
  return (
    <ScrollView className="flex-1 bg-ink" contentContainerClassName="px-6 pb-12 pt-14">
      <View className="mb-8">
        ...
        <Text className="mt-4 text-base leading-7 text-slate-300">
Choose an action below. ScreenSmart uses local AI when available, or free cloud when not — you can always see which in the usage tab.
        </Text>
      </View>

      <View className="gap-5">
        <ScreenCard eyebrow="Screen text" title="What was extracted">
  ...
  A placeholder response was used because no AI provider was available. Check Settings → Provider Status to see which providers are connected, then retry.
            </Text>
            <PrimaryButton label="Retry" onPress={() => generate(lastTask)} />
          </ScreenCard>
        ) : null}

        <ScreenCard eyebrow="AI response" title="What ScreenSmart found">
