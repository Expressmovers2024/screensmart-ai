...
export type UserSettings = {
  ...
  syncEnabled: boolean;
  updatedAt: string;
  /** ID of the user's chosen Ollama model, e.g. "llama3.1:8b" */
  preferredLocalModel?: string;
  /** When true, ProviderRouter tries Ollama before cloud providers */
  preferLocalModels: boolean;
  /** When false, ProviderRouter skips OpenRouter and only tries local + mock */
